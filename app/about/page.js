...
//                 </div>
//                 <div>
//                   <h3 className="text-xl font-semibold text-white mb-2">Expert Assistance</h3>
//                   <p className="text-gray-400">
...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About Us | Hewlett Printers Solution</title>
        <meta name="description" content="Learn about Hewlett Printers Solution - your trusted partner for new printers, accessories, and IT solutions." />
      </Head>
      ...
      <div className="bg-gray-950 text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 py-16 -mt-16 relative z-10">
          ...
          <section className="animate-section bg-gray-900 rounded-xl shadow-lg p-8 mb-16 border border-gray-800">
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
              Hewlett Printers Solution is a customer-first company focused on delivering value through new printers and IT solutions. We believe in quality and reliability — providing the latest technology with comprehensive setup guidance.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                Each device is carefully tested and quality-checked by our technicians. Our team includes experienced professionals in IT hardware and logistics, ensuring that every product meets a consistent quality standard.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                We are not affiliated with HP, Canon, Epson, or any OEM manufacturer. All product names are used for descriptive and compatibility purposes only.
              </p>
          ...
          <section className="animate-section mb-16">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <h2 className="text-3xl font-bold text-white mb-6">Our Story</h2>
                <p className="text-gray-400 mb-4">
                  Founded in 2015, Hewlett Printers Solution began as a small team of IT enthusiasts who saw an opportunity to provide quality printing technology and solutions to everyone.
                </p>
                <p className="text-gray-400 mb-4">
                  What started as a passion project in a garage has now grown into a trusted name in printing solutions, serving thousands of satisfied customers across the country.
                </p>
                <p className="text-gray-400">
                  Our journey has been guided by a simple principle: Technology should be reliable, accessible, and supported by expert guidance.
                </p>
              </div>
              <div className="md:w-1/2">
                <motion.div
          ...
          <section className="animate-section mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-center text-white mb-3">New Printers</h3>
                <p className="text-gray-400 text-center">
                  We offer the latest printer models from leading brands, ensuring quality and performance.
                </p>
              </motion.div>
              <motion.div
                className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-cyan-400 transition-all"
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-center text-white mb-3">Accessories</h3>
                <p className="text-gray-400 text-center">
                  Find all the necessary accessories and supplies to keep your printing running smoothly.
                </p>
              </motion.div>
              <motion.div
                className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-cyan-400 transition-all"
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-center text-white mb-3">Setup Guidance</h3>
                <p className="text-gray-400 text-center">
                  Our team provides comprehensive setup guidance to get your equipment working perfectly.
                </p>
              </motion.div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    We provide only new, high-quality printers and accessories from trusted brands.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Our team provides comprehensive setup guidance and technical advice for your printing needs.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Warranty Protection</h3>
                  <p className="text-gray-400">
                    All our products come with comprehensive manufacturer warranty for your peace of mind.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    We offer comprehensive IT solutions to integrate your printing needs with your business systems.
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-cyan-400 mb-3">CEO & Founder</p>
                  <p className="text-gray-400">
                    With 15+ years in IT hardware, Sarah leads our vision for technology solutions.
                  </p>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-cyan-400 mb-3">Head of Operations</p>
                  <p className="text-gray-400">
                    Michael ensures our processes meet the highest quality standards.
                  </p>
                </div>
              </motion.div>
              <motion.div
          ...
          <motion.section
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold mb-6">Ready to Experience the Hewlett Printers Solution Difference?</h2>
            <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">
              Discover our range of new printers, accessories, and IT solutions.
            </p>
            <motion.button
              className="bg-white text-gray-900 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors"
              whileHover={{ scale: 1.05 }}
